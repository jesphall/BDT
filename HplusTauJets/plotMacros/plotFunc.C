...
//    TFile *file410062 = TFile::Open("../output/410062_Wt_DS_inclusive_top.root");
//    TH1D *h410062 = (TH1D*)file410062->Get(var);
//    h410062->SetFillColor(8);
//    h410062->SetLineColorAlpha(8,0);
//    hs->Add(h410062);
//    norm = norm + h410062->Integral();
//    top = top + h410062->Integral();
//    
//    TFile *file410063 = TFile::Open("../output/410063_Wt_DS_inclusive_antitop.root");
//    TH1D *h410063 = (TH1D*)file410063->Get(var);
//    h410063->SetFillColor(8);
//    h410063->SetLineColorAlpha(8,0);
//    hs->Add(h410063);
//    norm = norm + h410063->Integral();
//    top = top + h410063->Integral();
    
    //add fakes and remove fake-fakes
    TFile *fileFakes = TFile::Open("../output/fakes_.root");
    TH1D *hFakes = (TH1D*)fileFakes->Get(var);

//    TFile *file361081S = TFile::Open("../output_fakes_S/361081_Sherpa_CT10_WplvWmqq.root");
//    TH1D *h361081S = (TH1D*)file361081S->Get(var);
//    
//    TFile *file361082S = TFile::Open("../output_fakes_S/361082_Sherpa_CT10_WpqqWmlv.root");
//    TH1D *h361082S = (TH1D*)file361082S->Get(var);
//    
//    TFile *file361083S = TFile::Open("../output_fakes_S/361083_Sherpa_CT10_WlvZqq.root");
//    TH1D *h361083S = (TH1D*)file361083S->Get(var);
//    
//    TFile *file361084S = TFile::Open("../output_fakes_S/361084_Sherpa_CT10_WqqZll.root");
//    TH1D *h361084S = (TH1D*)file361084S->Get(var);
//    
//    TFile *file361085S = TFile::Open("../output_fakes_S/361085_Sherpa_CT10_WqqZvv.root");
//    TH1D *h361085S = (TH1D*)file361085S->Get(var);
//    
//    TFile *file361086S = TFile::Open("../output_fakes_S/361086_Sherpa_CT10_ZqqZll.root");
//    TH1D *h361086S = (TH1D*)file361086S->Get(var);
//    
//    TFile *file361087S = TFile::Open("../output_fakes_S/361087_Sherpa_CT10_ZqqZvv.root");
//    TH1D *h361087S = (TH1D*)file361087S->Get(var);
//    
//    TFile *file361524S = TFile::Open("../output_fakes_S/361524_Wenu_Np4.root");
//    TH1D *h361524S = (TH1D*)file361524S->Get(var);
//
//    TFile *file361529S = TFile::Open("../output_fakes_S/361529_Wmunu_Np4.root");
//    TH1D *h361529S = (TH1D*)file361529S->Get(var);
//
//    TFile *file361510S = TFile::Open("../output_fakes_S/361510_Ztautau_Np0.root");
//    TH1D *h361510S = (TH1D*)file361510S->Get(var);
//    
//    TFile *file361511S = TFile::Open("../output_fakes_S/361511_Ztautau_Np1.root");
//    TH1D *h361511S = (TH1D*)file361511S->Get(var);
//    
//    TFile *file361512S = TFile::Open("../output_fakes_S/361512_Ztautau_Np2.root");
//    TH1D *h361512S = (TH1D*)file361512S->Get(var);
//    
//    TFile *file361513S = TFile::Open("../output_fakes_S/361513_Ztautau_Np3.root");
//    TH1D *h361513S = (TH1D*)file361513S->Get(var);
//    
//    TFile *file361514S = TFile::Open("../output_fakes_S/361514_Ztautau_Np4.root");
//    TH1D *h361514S = (TH1D*)file361514S->Get(var);
//    
//    TFile *file361530S = TFile::Open("../output_fakes_S/361530_Wtaunu_Np0.root");
//    TH1D *h361530S = (TH1D*)file361530S->Get(var);
//    
//    TFile *file361531S = TFile::Open("../output_fakes_S/361531_Wtaunu_Np1.root");
//    TH1D *h361531S = (TH1D*)file361531S->Get(var);
//    
//    TFile *file361532S = TFile::Open("../output_fakes_S/361532_Wtaunu_Np2.root");
//    TH1D *h361532S = (TH1D*)file361532S->Get(var);
//    
//    TFile *file361533S = TFile::Open("../output_fakes_S/361533_Wtaunu_Np3.root");
//    TH1D *h361533S = (TH1D*)file361533S->Get(var);
//    
//    TFile *file361534S = TFile::Open("../output_fakes_S/361534_Wtaunu_Np4.root");
//    TH1D *h361534S = (TH1D*)file361534S->Get(var);
//
//    TFile *file410000S = TFile::Open("../output_fakes_S/410000_ttbar_hdamp172p5_nonallhad.root");
//    TH1D *h410000S = (TH1D*)file410000S->Get(var);
//    
//    TFile *file410011S = TFile::Open("../output_fakes_S/410011_singletop_tchan_lept_top.root");
//    TH1D *h410011S = (TH1D*)file410011S->Get(var);
//    
//    TFile *file410012S = TFile::Open("../output_fakes_S/410012_singletop_tchan_lept_antitop.root");
//    TH1D *h410012S = (TH1D*)file410012S->Get(var);
//    
//    TFile *file410013S = TFile::Open("../output_fakes_S/410013_singletop_Wt_inclusive_top.root");
//    TH1D *h410013S = (TH1D*)file410013S->Get(var);
//    
//    TFile *file410014S = TFile::Open("../output_fakes_S/410014_singletop_Wt_inclusive_antitop.root");
//    TH1D *h410014S = (TH1D*)file410014S->Get(var);
//        
//    hFakes->Add(h361081S,-1);
//    hFakes->Add(h361082S,-1);
//    hFakes->Add(h361083S,-1);
//    hFakes->Add(h361084S,-1);
//    hFakes->Add(h361085S,-1);
//    hFakes->Add(h361086S,-1);
//    hFakes->Add(h361087S,-1);
//    hFakes->Add(h361524S,-1);
//    hFakes->Add(h361529S,-1);
//    hFakes->Add(h361510S,-1);
//    hFakes->Add(h361511S,-1);
//    hFakes->Add(h361512S,-1);
//    hFakes->Add(h361513S,-1);
//    hFakes->Add(h361514S,-1);
//    hFakes->Add(h361530S,-1);
//    hFakes->Add(h361531S,-1);
//    hFakes->Add(h361532S,-1);
//    hFakes->Add(h361533S,-1);
//    hFakes->Add(h361534S,-1);
//    hFakes->Add(h410000S,-1);
//    hFakes->Add(h410011S,-1);
//    hFakes->Add(h410012S,-1);
//    hFakes->Add(h410013S,-1);
//    hFakes->Add(h410014S,-1);
//    
...
//    h341529->DrawNormalized("hist:same",norm);
...
//    h341538->DrawNormalized("hist:same",norm);
//    h341540->DrawNormalized("hist:same",norm);
    hData->Draw("same");
...
//    leg1->AddEntry(h341529,"350GeV","l");
    leg1->AddEntry(h341003,"400GeV","l");
    leg1->AddEntry(hData,"Data","l");
    leg1->Draw();
    c1->cd(2);
    TLegend *leg2 = new TLegend(0.68,0.55,0.98,0.95);
    //leg2->SetHeader("From file");
    //leg2->SetNColumns(2);
    leg2->AddEntry(h410000,"ttbar + single top","f");
    leg2->AddEntry(h361500,"Z/W->e/mu","f");
    leg2->AddEntry(h361510,"Z/W->tau","f");
    leg2->AddEntry(h361081,"diboson","f");
    leg2->AddEntry(hFakes,"Fakes","f");
    leg2->AddEntry(h341531,"600GeV","l");
    leg2->AddEntry(h341535,"1000GeV","l");
//    leg2->AddEntry(h341538,"1600GeV","l");
//    leg2->AddEntry(h341540,"2000GeV","l");
    leg2->AddEntry(hData,"Data","l");
    leg2->Draw();
